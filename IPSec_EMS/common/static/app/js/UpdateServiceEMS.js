...
/* This factory used for calls to EMS web service, as EMS uses 'put' method for update
    This factory service is used for update operation i.e. to update a resource
    
    For example, updating information of a specific ikepolicy.
    ...
    resourceName: Name of resource which is getting updated (ikepolicies)
    resourceID: ID of resource which is getting updated (ikepolicy id)
*/

app.factory('UpdateServiceEMS', function($http, $rootScope, $localStorage, $mdDialog,
