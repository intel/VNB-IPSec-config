...
app.controller('UserDetailsController', function($scope, $rootScope, $http, $mdDialog, $mdMedia, 
    ...
    $rootScope.$on('refresh', function(event) {
        LoadDetailsService.showData($scope, 'users', $stateParams.id);
    });
    ...
    $scope.delete = function(ev, resource, id){
        ...
        $mdDialog.show(confirm).then(function() {
            http_headers['data'] = {}
            $http.delete($localStorage.resourceUrl1 + "/users/" + 
