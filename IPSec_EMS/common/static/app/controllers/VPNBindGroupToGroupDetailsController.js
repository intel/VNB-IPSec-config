...
app.controller('VPNBindGroupToGroupDetailsController', function($scope, $rootScope, $http, $mdDialog, $mdMedia, 
    ...
    $rootScope.$on('refresh', function(event) {
        LoadDetailsService.showData($scope, 'vpnbindgrouptogroup', $stateParams.id);
    });
