...
HTTP_RESOURCE = 'vpnbindlocalsitetoremotesite'


class CreateVPNBindGroupToRemoteSite(CommandResource):
    """Create an VPNBindGroupToRemoteSite"""
    resource = 'vpnbindgrouptoremotesites'
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            'name',
            metavar='NAME',
            help="Name of the VPNBindGroupToRemoteSite\n\n")

        parser.add_argument(
            '--description',
            default='',
            help="Description of the VPNBindGroupToRemoteSite\n\n")
...
class ShowVPNBindGroupToRemoteSite(CommandResource):
    """Show information of a given VPNBindGroupToRemoteSite"""
    resource = 'vpnbindgrouptoremotesites'
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            'id',
            metavar='VPNBINDGROUPTOREMOTESITE',
            help="ID or Name of VPNBindGroupToRemoteSite to search\n\n")

        return parser


class ListVPNBindGroupToRemoteSite(CommandResource):
    """List VPNBindGroupToRemoteSites"""
    resource = 'vpnbindgrouptoremotesites'
...
class UpdateVPNBindGroupToRemoteSite(CommandResource):
    """Update a given VPNBindGroupToRemoteSite"""
    resource = 'vpnbindgrouptoremotesites'
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            'id',
            metavar='VPNBINDGROUPTOREMOTESITE',
            help="ID or Name of VPNBindGroupToRemoteSite to update\n\n")
...
class DeleteVPNBindGroupToRemoteSite(CommandResource):
    """Delete a given VPNBindGroupToRemoteSite"""
    resource = 'vpnbindgrouptoremotesites'
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            'id',
            metavar='VPNBINDGROUPTOREMOTESITE',
            help="ID or Name of VPNBindGroupToRemoteSite to delete\n\n")
