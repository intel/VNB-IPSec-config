...
from services.api.serializers.utils_serializers import (
    ...
    check_peer_vpnendpointlocalsite_id, check_vpncertificate_exists,
...
class VPNBindLocalSiteToLocalSite(Resource):
    """Represents a VPNBindLocalSiteToLocalSite object"""
    resource_name = 'VPNBindLocalSiteToLocalSite'
    primary_key = 'id'
    secondary_keys = ('name',)
...
class VPNBindLocalSiteToLocalSiteSerializer(ConsulSerializer):
    """Serializer for VPNBindLocalSiteLocalsite"""
    consul_model = VPNBindLocalSiteToLocalSite
    ...
    peer_vpnendpointlocalsite_id = CustomUUIDField(
        format='hex_verbose',
        validators=[check_peer_vpnendpointlocalsite_id])
